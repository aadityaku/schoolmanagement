        ...
        <div class="col-4 mt-2">
            <div class="card bg-info">
                <div class="card-body">
                    ...
                    <h3 class="text-white">Total  Student :<span class="text-dark ">{{$c->student_count}}</span></h3>
                    {{-- @php $count=0; @endphp
                    ...
                    <a href="{{ route('student.viewattendance',['roll'=>$c->id]) }}" class="btn btn-success stretched-link float-end ">View All</a>
                </div>
            </div>
        </div>
    @endforeach
