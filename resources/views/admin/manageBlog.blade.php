...
@section('content')
          <h2 class="text-warning text-center">Manage Blog</h2>
            
            <a href="#insert" data-bs-toggle="modal" class="btn btn-success float-end mb-2">Insert Blogs</a>
            <table class="table">
                ...
                <div class="modal-body">
                    <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"  name="description" class="form-control @error('description') is-valid @enderror">{{ old('image') }}</textarea>
                            @error('description')
                                <p class="small text-danger">{{ $message}}</p>
                            @enderror
                        </div>
